...
##################
def create(group_name, user_list, group_total, is_active = True, department):
...
##################
def create_and_download(group_name, user_list, group_total, is_active = True, department):
  # Get exising file content
  all_group_classroom_data = get_existing_data('group_classroom.json')
...
def read(uuid = None):
  ...
  if uuid == None: group_classroom_as_class
